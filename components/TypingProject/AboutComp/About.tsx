  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col space-y-8  items-center">
        <span className="font-extrabold lg:text-5xl md:text-4xl text-2xl sm:text-3xl text-gray-800 text-center">
          What&apos;s this project for?
        </span>
        <span className="font-sans italic  sm:text-base text-sm text-gray-500 text-center">
          ...
          <span className="font-bold text-gray-800">aim for a typing speed of at least 40 WPM</span> to keep up a

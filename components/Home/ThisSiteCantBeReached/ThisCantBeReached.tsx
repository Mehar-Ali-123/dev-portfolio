      ...
      <div className="relative w-full  flex flex-col space-y-4">
        ...
        >
          ...
          <span className="text-gray-500 text-md">
            <span className="font-bold">nomi-nine.vercel.app </span>
            unexpectedly{" "}
            {ShowText ? (
              <motion.span
          ...
          <div className="flex flex-col space-y-3">
            <span className="font-Header text-gray-500 text-lg">Try:</span>
            <div className="flex flex-col space-y-2 pl-10">
              <span className="text-Header text-gray-500 font-Header sm:text-base text-sm">

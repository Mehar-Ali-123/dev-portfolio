...
import RemoteJob from "./Descriptions/RemoteJob";
  ...
  return (
    ...
    >
      ...
      <section className="flex flex-row items-center">
        <span className="text-AAsecondary  opacity-85 font-bold tracking-wider text-lg md:text-3xl px-3">
          Where I&apos;ve Worked
        </span>
...
const CompaniesBar = (props) => {
    ...
    return (
      <button
        ...
        className={`flex-none sm:text-sm text-xs text-center md:text-left  hover:text-AAsecondary
                      hover:bg-ResumeButtonHover rounded-r-lg mt-1  font-mono  
  ...
  return (
    ...
    >
      {/* // ? left bar Holder */}
      <div
        className=" hidden md:block bg-gray-500 relative h-0.5 w-34 md:h-[357px] translate-y-1 md:w-0.5  
